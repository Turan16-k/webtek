 ...
 *
 * 7. GÜNDE BULUNAN HATA:
 * Sadece istemci tarafında (JS/Vue) validasyon yapıyorduk.
 * Ama kullanıcı JS'i kapatırsa ya da Postman ile direkt istek
 * atarsa boş/hatalı veri geliyordu ve "Form Alındı!" sayfası açılıyordu.
 * Bu çok büyük bir güvenlik açığı. Sunucu tarafında da kontrol şart!
 * Hocamız "never trust the client" demişti, şimdi anladım neden.
 */
