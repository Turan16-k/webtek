...
<div style="margin-top:70px;" class="py-5">
    <div class="container">
        ...
        <div class="text-center mb-5">
            <div style="width:90px;height:90px;background:#198754;border-radius:50%;display:flex;align-items:center;justify-content:center;margin:0 auto 20px;font-size:2.5rem;color:#fff;">
